...
if (isset($_POST['save'])){
    ...
    $user_user = mysqli_real_escape_string($conn, $_POST['user']);
    ...
    $result= mysqli_query($conn,$sql)or die("QUERY FAILED.");
     if(mysqli_num_rows($result)>0){
        ...
        $sql1 = "INSERT INTO user(first_name,last_name,username,password,role) VALUES ('{$user_fname}','{$user_lname}','{$user_user}','{$user_password}','{$user_role}')";
