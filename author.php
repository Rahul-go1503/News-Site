        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <?php
                        include 'config.php';
                        $user_id = $_GET['id'];
                        $sql0="SELECT username FROM user WHERE user_id=$user_id"; 
                    ...
                    ?>
                    <h2 class="page-heading"><?php echo $row0['username'] ?></h2>
                    <?php
                    $limit = 3;
                    if (isset($_GET['page'])) {
                        $page = $_GET['page'];
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            echo "<li class=\" $active\" ><a href='{$hostname}\author.php?id={$user_id}&page={$i}'> $i </a></li>";
                        }
                        if ($page < $total_page) {
                            $add = $page + 1;
                            echo "<li><a href='{$hostname}/author.php?id={$user_id}&page={$add}'>Next</a></li>";
                        }
                        echo "</ul>";
                    }
                    mysqli_close($conn);
