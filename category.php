            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php
                        include 'config.php';
                        $cat_id = $_GET['id'];
                        $sql0="SELECT category_name FROM category WHERE category_id=$cat_id"; 
                    ...
                    ?>
                    <h2 class="page-heading"><?php echo $row0['category_name'] ?></h2>
                    <?php
                    $limit = 3;
                    if (isset($_GET['page'])) {
                        $page = $_GET['page'];
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            echo "<li class=\" $active\" ><a href='{$hostname}/category.php?id=$cat_id&page={$i}'> $i </a></li>";
                        }
                        if ($page < $total_page) {
                            $add = $page + 1;
                            echo "<li><a href='{$hostname}/category.php?id=$cat_id&page=$add'>Next</a></li>";
                        }
                        echo "</ul>";
                    }
                    mysqli_close($conn);
